...
function aef_default_copy() {
	return array(
		...
		'home_wef_eyebrow_en' => 'Co-branded with the World Economic Forum',
		'home_wef_eyebrow_vi' => 'Đồng thương hiệu với WEF',
		'home_wef_title_en'   => 'Linking the Global Agenda to Action Priorities in Viet Nam',
		'home_wef_title_vi'   => 'Kết nối chương trình nghị sự toàn cầu với ưu tiên hành động tại Việt Nam',
		'home_wef_lead_en'    => 'The Autumn Economic Forum is positioned on the WEF annual axis — Davos in winter, the Annual Meeting of the New Champions in China in summer, and the Forum in Ho Chi Minh City in autumn — with the ambition of becoming WEF’s annual mechanism in Viet Nam.',
		'home_wef_lead_vi'    => 'Diễn đàn Kinh tế Mùa thu được định vị trên trục thường niên của WEF — Davos mùa đông, Hội nghị các Nhà Tiên phong mùa hè tại Trung Quốc và Diễn đàn tại Thành phố Hồ Chí Minh vào mùa thu — hướng tới trở thành cơ chế thường niên của WEF tại Việt Nam.',
		'home_wef_item1_en'   => 'Co-branding and co-creation of content, joint delivery and mobilisation of WEF’s global network of experts and partners.',
		'home_wef_item1_vi'   => 'Đồng thương hiệu, đồng xây dựng nội dung và phối hợp triển khai; huy động mạng lưới chuyên gia, đối tác toàn cầu.',
		'home_wef_item2_en'   => 'Senior WEF leadership addresses the High-Level Plenary and joins the Dialogue with the Prime Minister of Viet Nam.',
		'home_wef_item2_vi'   => 'Lãnh đạo cấp cao WEF phát biểu tại Phiên Toàn thể và đối thoại cùng Thủ tướng Chính phủ Việt Nam.',
		'home_wef_item3_en'   => 'Co-chairing thematic sessions on global value chains and the manufacturing workforce in the age of AI.',
		'home_wef_item3_vi'   => 'Đồng chủ trì các phiên chuyên đề về chuỗi giá trị toàn cầu và nhân lực cho ngành sản xuất trong kỷ nguyên AI.',
		'home_wef_item4_en'   => 'The C4IR Global Network holds its annual gathering within the Forum; WEF supports communications across its platforms.',
		'home_wef_item4_vi'   => 'Mạng lưới C4IR toàn cầu họp mặt thường niên trong khuôn khổ Diễn đàn; hỗ trợ truyền thông trên các nền tảng của WEF.',
...
function aef_home_block_defs() {
	return array(
		...
		'wef'       => array(
			'label'  => 'Đồng thương hiệu với WEF',
			'help'   => 'Khối định vị AEF trên trục 3 mùa của WEF (Davos/Summer Davos/Thu). Nội dung lấy từ bản UI Concept v22 (tổ nội dung), trước đây bị bỏ sót khi build. Ảnh nền trống = giữ nền navy đậm hiện có.',
			'image'  => array(
				'home_wef_bg_id' => 'Ảnh nền khối này',
			),
			'fields' => array(
				'home_wef_eyebrow' => 'Eyebrow (để trống = ẩn)',
				'home_wef_title'   => 'Tiêu đề',
				'home_wef_lead'    => 'Đoạn dẫn',
				'home_wef_item1'   => 'Gạch đầu dòng 1',
				'home_wef_item2'   => 'Gạch đầu dòng 2',
				'home_wef_item3'   => 'Gạch đầu dòng 3',
				'home_wef_item4'   => 'Gạch đầu dòng 4',
			),
		),
		'week'      => array(
